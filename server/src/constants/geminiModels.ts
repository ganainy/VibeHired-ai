// server/src/constants/geminiModels.ts
/**
...
/** Lightweight 1.5-generation flash model — kept for high-volume / cost-sensitive batch operations */
export const GEMINI_FLASH_LITE = 'gemini-1.5-flash';

/** 8-billion parameter ultra-light model — for the most cost-sensitive tasks */
