...
| **Job Application Management** | AI job extraction from URLs, dashboard view, status tracking |
| **CV Management** | Multi-branch CV system, AI parsing, rich editor, AI analysis |
...
| **Review & Finalization** | AI draft review, PDF generation and download |
