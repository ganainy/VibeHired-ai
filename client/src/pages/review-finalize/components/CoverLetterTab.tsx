...
interface CoverLetterTabProps {
    ...
    onDownloadWord: () => void;
    onGenerateCoverLetterPdf: () => void;
    onDownload: (filename: string | null) => void;
    onSetIsEmailModalOpen: (open: boolean) => void;
    onDeleteCoverLetter: () => void;
    onSetClCreationMode: (mode: 'ai' | 'import') => void;
    onSetShowClLibraryPanel: (show: boolean) => void;
    onSetSelectedBaseClId: (id: string) => void;
    onSetClUploadFile: (file: File | null) => void;
    onSetApplyClError: (error: string | null) => void;
    onApplyBaseCoverLetter: () => void;
...
export const CoverLetterTab: React.FC<CoverLetterTabProps> = ({
    ...
    onCopyCoverLetter,
    onDownloadWord,
    onGenerateCoverLetterPdf,
    onDownload,
    onSetIsEmailModalOpen,
    onDeleteCoverLetter,
    onSetClCreationMode,
    onSetShowClLibraryPanel,
    onSetSelectedBaseClId,
    onSetClUploadFile,
    onSetApplyClError,
    onApplyBaseCoverLetter,
            ...
            {jobApplication.draftCoverLetterText ? (
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-3">
                                <div className="flex items-center gap-2">
                                    ...
                                    {/* Download PDF Button */}
                                    <button
                                        onClick={finalPdfCl ? () => onDownload(finalPdfCl) : onGenerateCoverLetterPdf}
                                    ...
                                    {/* Email Format Button */}
                                    <button
                                        onClick={() => onSetIsEmailModalOpen(true)}
                            ...
                            <div className="mt-4 p-4 rounded-xl space-y-4" style={{ background: 'var(--accent-bg)', border: '1px solid var(--accent-dim)' }}>
                                ...
                                <div className="space-y-1">
                                    ...
                                    <select
                                        ...
                                        onChange={(e) => { onSetSelectedBaseClId(e.target.value); onSetClUploadFile(null); }}
                                ...
                                <div className="space-y-1">
                                    ...
                                    <input
                                        ...
                                        ref={clUploadFileRef}
                                        className="hidden"
                                        onChange={(e) => { const f = e.target.files?.[0] ?? null; onSetClUploadFile(f); if (f) onSetSelectedBaseClId(''); }}
                                    />
                                    {clUploadFile ? (
                                        <div className="flex items-center gap-2 px-3 py-2 bg-white dark:bg-gray-600 border border-gray-200 dark:border-gray-600 rounded-lg text-sm">
                                            ...
                                            <button onClick={() => { onSetClUploadFile(null); if (clUploadFileRef.current) clUploadFileRef.current.value = ''; }} className="text-gray-400 hover:text-red-500 transition-colors">
                                ...
                                <div className="flex gap-2">
                                    <button
                                        onClick={onApplyBaseCoverLetter}
                                    ...
                                    <button
                                        onClick={() => { onSetShowClLibraryPanel(false); onSetApplyClError(null); }}
                        ...
                        {coverLetterError && (
                            <div className="mb-4">
                                <ErrorAlert
                                    ...
                                    onDismiss={() => onSetCoverLetterError(null)}
                                />
                            </div>
                        )}
                        <CoverLetterEditor
                ...
                <div>
                    ...
                    <div className="flex flex-col md:flex-row gap-3 md:gap-4 mb-8">
                        ...
                        <button
                            type="button"
                            onClick={() => onSetClCreationMode('ai')}
                        ...
                        <button
                            type="button"
                            onClick={() => onSetClCreationMode('import')}
                    ...
                    {clCreationMode === 'import' && (
                        <div className="card p-8 space-y-6">
                            ...
                            {applyClError && (
                                <ErrorAlert message={applyClError} onDismiss={() => onSetApplyClError(null)} />
                            )}
                            <div className="space-y-2">
                                ...
                                {clUploadFile ? (
                                    <div className="flex items-center gap-3 px-4 py-3 rounded-xl" style={{ background: "var(--accent-bg)", borderColor: "var(--accent-dim)", border: "1px solid var(--accent-dim)" }}>
                                        ...
                                        <button
                                            onClick={() => { onSetClUploadFile(null); if (clUploadFileRef.current) clUploadFileRef.current.value = ''; }}
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    <select
                                        value={selectedBaseClId}
                                        onChange={(e) => { onSetSelectedBaseClId(e.target.value); onSetClUploadFile(null); if (clUploadFileRef.current) clUploadFileRef.current.value = ''; }}
                                        disabled={!!clUploadFile || isApplyingBaseCl}
                            ...
                            <div className="flex items-center justify-end gap-3 pt-2">
                                <button
                                    onClick={() => { onSetClCreationMode('ai'); onSetApplyClError(null); onSetClUploadFile(null); onSetSelectedBaseClId(''); }}
                    ...
                    {clCreationMode === 'ai' && (
                        <>
                            ...
                            <div className="card p-8 space-y-8">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="relative">
                                            <select
                                                ...
                                                onChange={(e) => onSetSelectedClBaseCvId(e.target.value)}
                                ...
                                <PromptChecklist
                                    type="coverLetter"
                                    onChange={onSetClCustomInstructions}
                                />
                                ...
                                {!hasMasterCv && (
                                    <div className="mt-4 text-center">
                                        <p className="text-sm text-amber-600 dark:text-amber-400">
                                            You need to upload a CV first. Go to <Link to="/manage-cv" className="underline font-medium">CV Management</Link> to upload it.
                                        </p>
                                    </div>
                                )}
                            </div>
