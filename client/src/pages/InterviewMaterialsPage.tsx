...
const InterviewMaterialsPage: React.FC = () => {
 ...
 {/* Error */}
 {error && (
 <div className="flex items-center gap-2 text-sm px-3 py-2.5 rounded-xl border" style={{ borderColor: 'var(--rose)', backgroundColor: 'rgba(200,32,20,0.12)', color: 'var(--rose)' }}>
 ...
 className="w-full pl-8 pr-3 py-2 text-sm rounded-full border focus:outline-none focus:ring-1 focus:ring-gold"
 style={{
 ...
 className="w-full text-sm px-3 py-2 rounded-lg border focus:outline-none focus:ring-1 focus:ring-gold"
 style={{
 ...
 rows={6}
 className="w-full text-sm px-3 py-2 rounded-lg border focus:outline-none focus:ring-1 focus:ring-gold font-mono resize-y"
 style={{
 backgroundColor: 'var(--bg-surface)',
 borderColor: 'var(--border)',
 color: 'var(--text-primary)',
