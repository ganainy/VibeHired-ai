...
const AdminUserDetailPage: React.FC = () => {
 ...
 <p className="text-sm text-secondary-color">No user selected.</p>
 </div>
 </div>
 );
 }
 ...
 <p className="text-secondary-color mt-1">Manage access, usage, and CV previews.</p>
 </div>
 </div>
 ...
 <h2 className="text-base font-bold truncate" style={{ color: 'var(--text-primary)', fontFamily: 'Lora, Georgia, serif' }}>
...
className="w-1.5 h-1.5 rounded-full shrink-0"
 ...
 <span className="px-3 py-2 text-secondary-color font-mono text-xs">{usagePage} / {usageTotalPages}</span>
 <button
 ...
 <span className="px-3 py-2 text-secondary-color font-mono text-xs">{cvPage} / {cvTotalPages}</span>
 <button
 ...
 <div className="rounded-2xl border border-theme bg-surface p-8">
 <p className="text-sm text-secondary-color">User not found.</p>
 </div>
 )}
