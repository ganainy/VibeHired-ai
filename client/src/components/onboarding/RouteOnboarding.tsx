...
const PAGE_GUIDES: PageGuide[] = [
    ...
    },
    {
        ...
        title: 'Step 1: CV Library',
        description: 'Build your base CV here first. The dashboard reuses it to generate targeted application materials per job.',
        features: [
            'Create a clean base CV profile once',
            'Import from PDF or paste your current CV text',
