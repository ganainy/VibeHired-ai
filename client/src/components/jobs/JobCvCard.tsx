                            ...
                            <div className="mb-4 p-4 rounded-xl space-y-3 border" style={{background:"var(--accent-bg)", borderColor:"var(--accent-dim)"}}>
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        type="file"
                                        accept=".pdf,.docx"
                                        className="block w-full text-xs text-gray-600 dark:text-gray-400 file:mr-3 file:py-1.5 file:px-3 file:border-0 file:rounded file:text-xs file:font-medium file:bg-gold-100 dark:file:bg-gold-900/30 file:text-gold-700 dark:file:text-gold-300 hover:file:cursor-pointer"
