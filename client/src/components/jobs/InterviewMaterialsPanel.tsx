                ...
                <div className="flex items-center gap-2 mt-2.5" onClick={(e) => e.stopPropagation()}>
                    <button
                        ...
                        className={`relative inline-flex h-5 w-9 items-center rounded-full transition-colors focus:outline-none disabled:opacity-50 ${
                            material.isGlobal ? 'bg-amber-400' : 'bg-gray-300 dark:bg-gray-600'
                        }`}
...
const InterviewMaterialsPanel: React.FC<Props> = ({ jobId }) => {
    ...
    return (
        <div className="space-y-5">
            ...
            {/* Error */}
            {error && (
                <div className="flex items-center gap-2 text-sm px-3 py-2 rounded-lg bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 border border-red-200 dark:border-red-800">
                    ...
                    <div className="flex items-center gap-2.5 pt-1">
                        <button
                            ...
                            className={`relative inline-flex h-5 w-9 items-center rounded-full transition-colors focus:outline-none ${
                                form.isGlobal ? 'bg-amber-400' : 'bg-gray-300 dark:bg-gray-600'
                            }`}
                        >
                            <span
                                className={`inline-block h-3.5 w-3.5 rounded-full bg-white shadow-sm transform transition-transform ${
